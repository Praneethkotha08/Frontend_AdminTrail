...
function Modify() {
    ...
    useEffect(() => {
        Axios.get("https://project-final-backend-bq77.onrender.com/carRoute/update-car/" + id)
            .then((res) => {
                if (res.status === 200) {
                    const {
                        img1,
    ...
    const handleSubmit = () => {
        ...
        Axios.put("https://project-final-backend-bq77.onrender.com/carRoute/update-car/" + id, data)
            .then((res) => {
                if (res.status === 200)
